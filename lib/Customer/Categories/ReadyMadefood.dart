...
class ReadyMadeFood extends StatefulWidget {
  @override
  _ReadyMadeFoodState createState() => _ReadyMadeFoodState();
}

class _ReadyMadeFoodState extends State<ReadyMadeFood> {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: StreamBuilder<QuerySnapshot>(
          stream: db.collection('ReadyMadeFood').snapshots(),
        ...
        child: Stack(
          children: [
            Positioned(
              ...
              child: CircleAvatar(
                radius: width1 * 0.15,
                backgroundImage: NetworkImage(doc.data()['imgUrl']),
              ),
            ),
            Positioned(
                top: height1 * 0.015,
