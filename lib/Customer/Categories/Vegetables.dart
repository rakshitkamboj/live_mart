...
class FruitVeg extends StatefulWidget {
  @override
  _FruitVegState createState() => _FruitVegState();
}

class _FruitVegState extends State<FruitVeg> {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: StreamBuilder<QuerySnapshot>(
          stream: db.collection('FruitsVegetables').snapshots(),
